...
function ConnectFeature({ icon, label }: { icon: string; label: string }) {
  return (
    <div style={{
...
export function ConnectScreen({ onConnect }: ConnectScreenProps) {
  const [email, setEmail] = useState("kemkum@arc-vault.io");
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <ConnectFeature icon="lock"       label="Token yenilemesi Xbox bilgileri ile otomatik" />
          </div>
        </div>
        ...
        <div style={{ padding: "40px", display: "flex", flexDirection: "column", gap: 22 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <Field label="API Adresi" hint="Lokal ARC Vault sunucusu">
              <input value="http://localhost:8000" readOnly style={{ ...inputStyle, color: "var(--fg-4)" }} />
            </Field>
          </div>
          ...
          <div style={{
            ...
            <span style={{ color: "#00d2ff", display: "inline-flex" }}>
              <Icon name="shield" size={16} />
            </span>
            <span>
              Token süresi dolduğunda <strong style={{ color: "#00d2ff" }}>Ayarlar</strong> sayfasından Xbox bilgilerinizi girerek otomatik yenileme yapabilirsiniz.
            </span>
          </div>
